...
export const ROUTED_TARGET = 'auto';
export const ANY_TARGET = 'any';
...
const DENIALS = {
  ...
  [ACTIONS.WORKSPACE_WRITE]: { code: 'approval_required', message: 'Workspace writes require approval.' },
};
...
const isKnownAction = (action) => Object.values(ACTIONS).includes(action);
