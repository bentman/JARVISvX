...
export class VoiceRuntime {
  ...
  setMode(mode) { if (!localVoiceModes.includes(mode)) throw new Error(`Unsupported local voice mode: ${mode}.`); this.mode = mode; this.publish({ type: 'voice-state', state: this.state, mode }); }
