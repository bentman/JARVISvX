...
export class VoiceRuntime {
  constructor({ database, publish }) { this.database = database; this.publish = publish; this.bootstrap = new VoiceModelBootstrap({ publish }); this.state = 'bootstrap'; this.detail = null; this.mode = 'wake'; }
  async initialize() {
    this.detail = null;
