...
export class AcpAdapter {
  ...
  buildCliArgs(cmd, prompt, instructions, mode = PROCESS_MODES.readOnly, cwd) {
    const readOnlyNotice = mode === PROCESS_MODES.readOnly
      ? '\n\nRead-only mode: Do not create, write, or modify any files in the workspace. Return your analysis directly in text.'
      : '';
    const fullText = (instructions ? `${instructions}\n\nTask: ${prompt}` : prompt) + readOnlyNotice;
