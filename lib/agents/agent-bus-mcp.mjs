export class AgentBusMcpServer {
  ...
  getTools() {
    return [
      ...
      {
        name: 'agents_ask',
        description: 'Delegates a specialized sub-task to a named agent identity (e.g. security, reviewer, debugger).',
        parameters: {
  ...
  async executeTool(toolName, params, context = {}) {
    ...
    if (toolName === 'agents_send') {
      return { success: true, status: 'delivered', runId: params.runId };
    }
