...
export class DaemonClient {
  ...
  // Agent runtime — CRUD is served through generic json() from the CLI (agents.mjs
  // routes), runAgent() covers solo/panel/debate the same way the TUI's @agent and
  // /panel /debate commands already do.
  ...
  // Skills — including the real skills.sh import/export pipeline (see lib/skills-source.mjs).
  ...
  // Consolidated settings (Phase 1's GET /settings/effective) and orchestration mode.
