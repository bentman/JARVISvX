import { Activity, Bot, ChevronRight, CircleStop, Cloud, Cpu, FileText, FolderPlus, MessageSquarePlus, Mic, Send, Settings2, X } from 'lucide-react';
