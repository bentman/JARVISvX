...
export default function App() {
  ...
  const send = async (event?: FormEvent, dictated?: string, origin: 'desktop-text' | 'voice' = 'desktop-text', targetConversationId?: string | null) => {
    ...
    const optimisticAssistant = { id: assistantMessageId, role: 'assistant' as const, content: '', reasoning: '', status: 'streaming', created_at: new Date().toISOString() };
